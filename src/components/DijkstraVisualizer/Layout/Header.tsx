    ...
    <div className="space-y-4">
      <div className="flex justify-between items-start">
        <div className="space-y-2">
          <div>
            <h2 className="text-2xl font-bold text-white">Dijkstra's Algorithm Visualizer</h2>
            <p className="text-slate-300">Find the shortest path between nodes</p>
          </div>
          <InfoPanel isOpen={showInfo} onToggle={() => setShowInfo(!showInfo)} />
        </div>
        ...
        <div className="flex flex-wrap gap-2 items-start justify-end">
          ...
          <Button
            variant="primary"
            onClick={() => setSelectionMode(selectionMode === 'via' ? null : 'via')}
